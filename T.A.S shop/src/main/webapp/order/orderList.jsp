		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-xl-10 ftco-animate">
					<h3 class="mb-4 billing-heading">${sessionScope.loginfo.name}(${sessionScope.loginfo.id})님 주문 내역</h3>
					<hr>
					<p>
						${sessionScope.loginfo.name}님이 <br>
						<strong>${order.orderdate}</strong>에 구매하신 상품에 대한 주문 내역입니다.
					</p>
					<hr>
							...
							<table class="table table-striped table-hover">
								...
								<tr class="header">
									<td colspan="4" align="center">
										...
										&nbsp;&nbsp;
										<a href="<%=Noform%>prList">계속 쇼핑하기</a>
									</td>
									<td colspan="4" align="center">
										총 금액 : 
