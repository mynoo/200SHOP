                ...
                <li><a href="#">Business Problem <span class="fa fa-chevron-right"></span></a></li>
					...
					<div class="sidebar-box ftco-animate">
						...
						<div class="block-21 mb-4 d-flex">
							<div class="text">
								<h3 class="heading">
									<a href="https://brunch.co.kr/@paxcom/268"> 술은 성질이 따뜻해서 몸의
										체온을 올리고 혈액순환을 왕성하게 하며 통증을 줄여준다. </a>
								</h3>
								<div class="meta">
									<div>
						...
						<div class="block-21 mb-4 d-flex">
							<div class="text">
								<h3 class="heading">
									<a
										href="http://blog.yes24.com/blog/blogMain.aspx?blogid=silvianim&artSeqNo=423273">
										청주는 일반적으로 15~20도가 적당하고, 데워서 마실 때는 40~45도 정도가 좋다. </a>
								</h3>
								<div class="meta">
									<div>
										<a href="#"><span class="fa fa-calendar"></span> Apr. 18,
					...
					<c:if test="${whologin == 2}">
						<div class="button" align="right">
							<a href="board_Detail" class="btn btn-primary">write</a>
						</div>
					</c:if>
					<div class="sidebar-box ftco-animate">
						<h3>Tag Cloud</h3>
						<div class="tagcloud">
							<a href="#" class="tag-cloud-link">counsel</a> <a href="#"
								class="tag-cloud-link">problem</a> <a href="#"
								class="tag-cloud-link">family</a> <a href="#"
								class="tag-cloud-link">personal</a> <a href="#"
								class="tag-cloud-link">business</a> <a href="#"
								class="tag-cloud-link">computer</a> <a href="#"
								class="tag-cloud-link">house</a> <a href="#"
								class="tag-cloud-link">technology</a>
						</div>
					</div>
