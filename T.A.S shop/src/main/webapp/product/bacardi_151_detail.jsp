			...
			<div
				...
				<div class="col-md-9 ftco-animate mb-5 text-center">
					<p class="breadcrumbs mb-0">
						...
						</a></span> <span><a href="../product/product.jsp">Products <i
			...
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="../images/prod-1.jpg" class="image-popup prod-img-bg"><img
						src="../images/prod-1.jpg" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>
						<a href="../order/order.jsp"
							class="btn btn-primary py-3 px-5 mr-2">Add to Cart</a><a
							href="../orderdetail/order_detail.jsp"
