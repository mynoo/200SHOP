...
<head>
	...
	<script type="text/javascript">
		...
		function sendAddress(fname, zipcode, roadaddress, address1, address2, extraaddress) {
				...
				<tbody>
					<c:forEach var="bean" items="${requestScope.lists}">
						<tr>
							...
							<td>
								<a href="#" onclick="javascript:sendAddress('${bean.fname}', '${bean.zipcode}', '${bean.roadaddress}', '${bean.address1}', '${bean.address2}', '${bean.extraaddress}');">
									${bean.fname}
								</a>
							</td>
							<td> ${bean.zipcode} </td>
